...
##################################################
# CitySelection_Script
##################################################
# -> Script for selecting city with highest
#    growth potential
##################################################
def CitySelection_Script(general_params, preprocessor, tier_1_2_cities_raw, output_save_path, plotly_save_path):
    ...
    # Clear previously saved forecast features to save the new forecasted features
    ...
    # Finding airport & coordinates of city
    ...
    # We now find all airports of given air network
    # Purpose of doing this is to then exclude those cities which are already part of airline's network
    ...
    # Exclude those cities which are already part of airline's network

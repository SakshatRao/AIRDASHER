...
var slider_out = document.getElementById("price_out_slider");
var output_out = document.getElementById("selected_price_out");
output_out.innerHTML = slider_out.value;

slider_out.oninput = function() {
    output_out.innerHTML = this.value;
}